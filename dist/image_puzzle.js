...
export class ImagePuzzle {
        ...
        for (let row = 0; row < gridSize; row++) {
            for (let col = 0; col < gridSize; col++) {
                ...
                if (tileValue !== 0) {
                    ...
                    this.ctx.drawImage(image, sourceX, sourceY, image.width / gridSize, image.height / gridSize, col * this.tileSize, row * this.tileSize, this.tileSize, this.tileSize);
                }
    ...
    render(gridSize, image) {
        this.ctx.clearRect(0, 0, this.canvas.width, this.canvas.height);
        this.drawTiles(gridSize, image);
    }
    gameLoop(gridSize, image) {
